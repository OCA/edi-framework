...
class OutboundInstructionTestCase(ShipmentTestCaseBase):
    _schema_path = (
        "edi_gs1_oca:static/schemas/gs1/ecom/WarehousingOutboundInstruction.xsd"
    )
    ...
    def setUpClass(cls):
        ...
        cls.exc_type = cls.env.ref(
            "edi_gs1_stock_oca.edi_exchange_type_outbound_instruction"
        )
    ...
    def test_generator_wired(self):
        self.assertEqual(
            ...
            "edi.gs1.generate.outbound.instruction",
        )
