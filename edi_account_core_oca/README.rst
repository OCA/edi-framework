...
`feedback <https://github.com/OCA/edi-framework/issues/new?body=module:%20edi_account_core_oca%0Aversion:%2019.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/edi-framework <https://github.com/OCA/edi-framework/tree/19.0/edi_account_core_oca>`_ project on GitHub.
