...
- It implements the EDI processing listener using the OCA component
  framework, allowing custom behaviors to be executed when EDI records
  are processed.
...
.. |maintainer-ArnauCForgeFlow| image:: https://github.com/ArnauCForgeFlow.png?size=40px
    :target: https://github.com/ArnauCForgeFlow
    :alt: ArnauCForgeFlow

Current `maintainer <https://odoo-community.org/page/maintainer-role>`__:

|maintainer-ArnauCForgeFlow| 
