...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:3bab37ebd62518d7fd581efa6c8d7c9b3c3f493f3514089083bb4cf8024e1a68
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fedi--framework-lightgray.png?logo=github
    :target: https://github.com/OCA/edi-framework/tree/18.0/edi_webservice_component_oca
    :alt: OCA/edi-framework
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/edi-framework-18-0/edi-framework-18-0-edi_webservice_component_oca
...
It used to be part of ``edi_webservice_oca`` itself; it now lives here
so that installing ``edi_webservice_oca`` no longer requires
``component`` unless you actually need this integration style.
...
`feedback <https://github.com/OCA/edi-framework/issues/new?body=module:%20edi_webservice_component_oca%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/edi-framework <https://github.com/OCA/edi-framework/tree/18.0/edi_webservice_component_oca>`_ project on GitHub.
